...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =																	
	{
		...
		ERROR_ENTRY(323, "[ SEMANTIC ] Ошибка в выражении: деление на нуль"),
		ERROR_ENTRY(324, "[ SEMANTIC ] Имя интедефикатора больше 10"),
		ERROR_ENTRY(325, "[ SEMANTIC ] "), ERROR_ENTRY_NODEF(326),
